  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4 items-start justify-center p-4 my-20 text-brand-gray-medium container mx-auto max-w-[700px] font-mulish">
        <h1 className="text-3xl font-semibold text-white text-left">Tabata with <Link href="/coaches-trainers/steve" className="text-brand-orange hover:underline">Steve</Link> – Maximum Efficiency, Maximum Results.</h1>
