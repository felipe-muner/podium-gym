export default function MichaPage() {
  return (
        ...
        <div className="rounded-lg bg-white p-8 shadow-lg">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Právílo stretching, flexibility training, and body alignment therapy.
            </p>
          </div>
          <div>
            <h3 className="mb-3 text-xl font-bold text-gray-900">
            ...
            <p className="mb-4 text-gray-600">
              Ready to experience Právílo with Micha?
            </p>
            <a
              href="/contact"
