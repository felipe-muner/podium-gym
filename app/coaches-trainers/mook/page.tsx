export default function MookPage() {
  return (
      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        <div className="rounded-lg bg-white p-8 shadow-lg">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">Thai, English</p>
          </div>
          <div className="mb-8">
            <h3 className="mb-3 text-xl font-bold text-gray-900">
              Specialization
            ...
            <p className="text-gray-600">
              Reformer Pilates, flexibility, and body alignment.
            </p>
          </div>
          <div>
            <h3 className="mb-3 text-xl font-bold text-gray-900">
            ...
            <p className="mb-4 text-gray-600">
              Ready to experience Reformer Pilates with Mook?
            </p>
            <a
              href="/contact"
