      ...
      <section className="relative h-[400px] bg-black">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
          ...
          <p className="max-w-2xl text-xl text-gray-200">
            CrossFit & Hyrox Coach, Personal Trainer
          </p>
        </div>
      </section>
        ...
        <div className="rounded-lg bg-white p-8 shadow-lg">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Hyrox training, CrossFit coaching, Maximum Mobility, functional fitness, and endurance conditioning.
            </p>
          </div>
          <div>
            <h3 className="mb-3 text-xl font-bold text-gray-900">
            ...
            <p className="mb-4 text-gray-600">
              Ready to level up your training with Charlene?
            </p>
            <a
              href="/contact"
