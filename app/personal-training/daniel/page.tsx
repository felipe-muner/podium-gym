      ...
      <section className="relative h-[400px] bg-black">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center px-4 text-center">
          ...
          <p className="max-w-2xl text-xl text-gray-200">
            Personal Trainer - English, Hebrew
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        <div className="rounded-lg bg-white p-8 shadow-lg">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">English, Hebrew</p>
          </div>
          <div className="mb-8">
            <h3 className="mb-3 text-xl font-bold text-gray-900">
              Specialization
            ...
            <p className="text-gray-600">
              Strength and conditioning, sports performance, and injury prevention.
            </p>
          </div>
          <div>
            <h3 className="mb-3 text-xl font-bold text-gray-900">
            ...
            <p className="mb-4 text-gray-600">
              Ready to start your fitness journey with Daniel?
            </p>
            <a
              href="/contact"
